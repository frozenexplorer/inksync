          ...
          >
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                <div className="flex-1 px-4 py-3 bg-(--surface) border border-(--border) rounded-lg font-mono text-lg tracking-wider">
                  {roomId}
                </div>
                <button
                  onClick={handleCopyCode}
                  className={`px-4 py-3 cursor-pointer rounded-lg font-medium transition-all duration-200 ${
                    copiedCode 
                      ? "bg-green-500 text-white" 
                      : "bg-(--surface-hover) hover:bg-(--primary) hover:text-black border border-(--border)"
                  }`}
                >
                  {copiedCode ? (
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                <div className="flex-1 px-4 py-3 bg-(--surface) border border-(--border) rounded-lg text-sm truncate text-(--text-muted)">
                  {inviteLink}
                </div>
                <button
